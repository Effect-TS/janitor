...
**Superseded by [hosting OpenCode in the sandbox-owning object](0004-host-opencode-in-the-sandbox-owning-object.md).** Retained as the record of the SQLite-only interval.
