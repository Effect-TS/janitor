...
export const inputClass =
  "h-7 w-full min-w-0 rounded-sm border border-border bg-surface-muted px-2 py-1 text-body-md text-foreground outline-none transition-colors duration-120 ease-ui placeholder:text-muted-foreground focus-visible:border-primary focus-visible:bg-card aria-invalid:border-destructive file:inline-flex file:h-5 file:border-0 file:bg-transparent file:text-body-sm file:font-medium file:text-foreground disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50"
